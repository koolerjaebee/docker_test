...
ui <- navbarPage("Basic statistics",
  ...
  fixedPanel(
    emailjsr::use_emailjsr_ui("feedback", "피드백"),
    right = 10,
    bottom = 10
  )
)
...
server <- function(input, output, session) {
  emailjsr::use_emailjsr_server("feedback", service_id = "zarathu", template_id = "template_8lmtpd9", user_id = "tSun__RsyK2JiDqUr", access_token = "VhkE4CkuPhJEf2r4czY6a", language = "ko")
